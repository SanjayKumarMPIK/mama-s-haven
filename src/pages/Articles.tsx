...
const articles: Article[] = [
  ...
  { title: "Understanding Practice Contractions vs Real Contractions", category: "Health", readTime: "4 min", color: "bg-peach/60", excerpt: "Key differences to know so you're confident about when to call your provider.", phases: ["maternity"] },
