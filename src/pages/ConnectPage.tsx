...
import {
  ArrowLeft, Stethoscope, Send, CheckCircle2, Clock, AlertCircle,
  XCircle, UserCheck,
} from "lucide-react";
import { Link } from "react-router-dom";
import { createRequest, getRequestByCode } from "@/lib/connectionStore";
...
export default function ConnectPage() {
  ...
  const handleSubmit = () => {
    ...
    const req = createRequest(doctorCode.trim());
    if (req) {
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 text-center">
              ...
              {connection.status === "accepted" && (
                <>
                  ...
                  <h2 className="text-lg font-bold text-gray-900 mb-2">Connected to Doctor</h2>
                  <p className="text-sm text-gray-500 mb-4">Your request has been accepted. You are now connected.</p>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-50 border border-green-200 text-sm font-medium text-green-700">
