...
import { usePubertyFitnessMetrics } from "../hooks/usePubertyFitnessMetrics";
import {
  Activity,
  ArrowLeft,
  Droplets,
...
export default function PubertyFitnessHealthCalculatorPage() {
  const { metrics, profile, healthSignals } = usePubertyFitnessMetrics();
